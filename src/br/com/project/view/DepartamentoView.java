 ...
 * @author Erick
 */
public class DepartamentoView extends javax.swing.JDialog {

    /**
     * Creates new form DepartamentoView
     */
    public DepartamentoView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.listdep = new DepartamentoBean().listDep();
        this.organizaTabela();
    }
    ...
    private void initComponents() {
        ...
        DepartamentoField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                DepartamentoFieldFocusLost(evt);
            }
        });

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Departamentos Cadastrados"));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(DepartamentoField, javax.swing.GroupLayout.PREFERRED_SIZE, 298, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void excluirBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirBTActionPerformed
        new DepartamentoBean().excluir(dep);
        this.listdep = new DepartamentoBean().listDep();
    ...
    private void salvarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarBTActionPerformed
        try {
            dep.setNomeDpto(DepartamentoField.getText());
        } catch (NullPointerException e) {
            dep = new Departamento();
            dep.setNomeDpto(DepartamentoField.getText());
        }
        new DepartamentoBean().salvar(dep);
        this.organizaTabela();
    ...
    private void DepartamentoFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_DepartamentoFieldFocusLost
        String a = DepartamentoField.getText().toUpperCase();
        DepartamentoField.setText(a);
    }//GEN-LAST:event_DepartamentoFieldFocusLost
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DepartamentoView dialog = new DepartamentoView(new javax.swing.JFrame(), true);
    ...
    private List<Departamento> listdep = new ArrayList<>();
    private Departamento dep;
    private int flag = 0;

    public List<Departamento> getListdep() {
        return listdep;
    }
